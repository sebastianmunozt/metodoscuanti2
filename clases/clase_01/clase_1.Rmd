...
- Volveremos donde estábamos:

- llevar a cabo el terreno (Pretest)
- R en Google Colab
...
-	ASISTENCIA:  
  + mínimo 70% asistencia en actividades lectivas. En total son 26 clases considerando separadamente los dos bloques del día (martes 13:00 a 14:20 y viernes 14:30 a 15:50). Para aprobar deberá asistir al menos a **18 bloques**, aceptando **8 inasistencias**. 
...
- Levantamiento de datos: Pre-Test(curso) y encuesta(toda la carrera).
- Uso de R
...
|----------------------|-------------------|-----------|-------|-------------|
| 📝 Tarea 1: Formulario corregido | Formulario corregido (Googleforms) según comentarios del profesor (1er semestre) | Grupal | 25-08 | S.P. |
| 📝 Tarea 2: Realización de Prueba Piloto | Prueba piloto con compañerxs del curso | Grupal | 01 - 09 | S.P.|
...
*Identificación de Literatura*: Úsenla para identificar y mapear fuentes bibliográficas académicas (las cuales deberás leer y analizar directamente). Eh: elicit.com
...
## Uso de IA: Riesgos y el Impacto Personal
...
*Des-habilidades (De-skilling)*: El riesgo personal más profundo. El uso excesivo atrofia su capacidad neuronal para leer críticamente, analizar fenómenos complejos y estructurar argumentos propios.
