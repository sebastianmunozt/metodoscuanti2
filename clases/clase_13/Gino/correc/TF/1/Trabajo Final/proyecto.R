...
#Esta tabla presenta un error, si se está midiendo la importancia de la credibilidad porqué dice educación de la madre?
...
#Comentarios= muy buen trabajo, ordenado y claro. 
#Como consejo los nombres de las categorías de los gráficos en lugar de dejarlos escritos hacia abajo
#es mejor usar coord_flip o algun otro metodo en donde las barras queden en el eje y
