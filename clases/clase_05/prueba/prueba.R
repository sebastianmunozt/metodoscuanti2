...
#0.2 Modificar el tercer elemento de EDAD, asignándole el valor 30
...
#0.4 Crear un dataframe (llamarla: BASE_DATOS) que contenga todos los vectores creados previamente

#0.5 Crear un objeto llamado SEGUNDA_FILA que guarde el valor contenido de la segunda fila del dataframe BASE_DATOS

#0.6 Crear un objeto llamado TERCERA_COLUMNA que guarde el valor contenido de la tercera columna del dataframe BASE_DATOS

#0.7 Crear un objeto llamado OTRA_COSA que guarde el valor contenido de la segunda fila y tercera columna del dataframe BASE_DATOS
...
#detalle la ruta desde el punto de partida del proyecto y asignándola a base_covid
...
#02.a. realicelo con el método de NOMBRE de las variables, guarde lo realizado como base_covid_r1

#02.c realicelo con la POSICIÓN de las variables, guardelo como base_covid_r2.
...
#06. Crear una nueva base (base_covid4) recodificando la variable edad en 4 rangos etáreos.
